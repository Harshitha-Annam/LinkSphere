...
export const LogIn = ({ setIsSignedIn }) => {
    ...
    return (
        <>
            <div className="signup-page"><section className="signup-container">
                <div className="signup-header"><p>Welcome Back to <span style={{color:"rgb(19, 113, 168)"}}>LinkSphere!</span></p></div>
                ...
                <div className="have-an-account"><p>Don't have an account? <Link to="/signup">SignUp</Link></p></div>
